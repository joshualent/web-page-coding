...
After you make changes to a file, you need to save your code with `Ctrl` + `S`. This will update your webpage being displayed with Live Server and save your changes to your computer. Alternatively, you can enable `Auto Save` to save your code automatically
